        ...
        <div class="my_div my_bg"> 
                <div class="index-mid" >
                        ...
                        <div class="input-group rounded-pill" style="background-color: white;">
                          ...
                          <div class=" radioCheck align-items-center pt-sm-2 pt-md-3" style="margin-left:380px;">
                            <div class="form-check form-check-inline mb-0" style="width:200px;">
                              <input class="form-check-input" type="radio" name="boardSearch" value="title" checked id="title">
                              <label class="form-check-label" for="writer">제목</label>
                            </div>
                            <div class="form-check form-check-inline mb-0"  style="width:200px;">
                              <input class="form-check-input" type="radio" name="boardSearch" value="writer" id="writer">
                              <label class="form-check-label" for="title">작성자</label>
                            </div>
                            <div class="form-check form-check-inline mb-0"  style="width:200px;">
                              <input class="form-check-input" type="radio" name="boardSearch" value="content" id="content">
                    ...
                    <div class="table-responsive">
                        <table class="tableBoard" id="type">
                        <thead>
                            <tr>
                            <th>번호</th>
                            <th>제목</th>
