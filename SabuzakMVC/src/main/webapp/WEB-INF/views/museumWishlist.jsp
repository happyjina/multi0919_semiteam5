...
<jsp:include page="/WEB-INF/views/common/header.jsp"/>
 ...
 <link rel="stylesheet" href="${path}/resources/css/museumWishlist.css">
        ...
        <div class="row pt-sm-2 pt-lg-0">
          ...
          <section id="bc" class="container">
            <ol id="bc2" class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page" id="brMuName">내가 찜한 박물관</li>
            </ol>
          </section>
          <!-- 사이드 바!!!!!!!-->
          ...
          <div class="col-lg-9 pt-4 pb-2 pb-sm-4 mb-5">
            <div class="d-flex align-items-center mb-4">
              <h1 class="h2 mb-0">내가 찜한 박물관 <span class='fs-base fw-normal text-muted'>(9개)</span></h1>
              ...
              <div class="card-body pb-4">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
                  ...
                  <div class="favoriteImg col pb-2 pb-sm-3">
                    <div class="card-hover position-relative rounded-1">
                      ...
                      <div class="swiper swiper-nav-onhover" data-swiper-options="{&quot;loop&quot;: true, &quot;navigation&quot;: {&quot;prevEl&quot;: &quot;.btn-prev&quot;, &quot;nextEl&quot;: &quot;.btn-next&quot;}}"><a class="swiper-wrapper" href="museumDetails.html">
                          <div class="swiper-slide p-2 p-xl-3"><img class="d-block mx-auto" src="${path}/resources/img/museum1.JPG" width="226" alt="favoriteMuseum" id="favoriteMuseum"></div>
                          <div class="swiper-slide p-2 p-xl-3"><img class="d-block mx-auto" src="${path}/resources/img/museum2.JPG" width="226" alt="favoriteMuseum" id="favoriteMuseum"></div>
                        </a>
                    ...
                    <div class="d-flex mb-1" id="mutext">
                      <h3 class="h6 mb-0" id="museName"><a href="antiquityDetails.html">박물관1</a></h3>
                    </div>
                  </div>
                  ...
                  <div class="favoriteImg col pb-2 pb-sm-3">
                    ...
                    <div class="d-flex mb-1" id="mutext">
                      <h3 class="h6 mb-0" id="museName"><a href="antiquityDetails.html">박물관2</a></h3> 
                    </div>
                  </div>
                  ...
                  <div class="favoriteImg col pb-2 pb-sm-3">
                    ...
                    <div class="d-flex mb-1" id="mutext">
                      <h3 class="h6 mb-0" id="museName"><a href="antiquityDetails.html">박물관3</a></h3> 
                    </div>
                  </div>
                  ...
                  <div class="favoriteImg col pb-2 pb-sm-3">
                    ...
                    <div class="d-flex mb-1" id="mutext">
                      <h3 class="h6 mb-0" id="museName"><a href="antiquityDetails.html">박물관4</a></h3>
                    </div>
